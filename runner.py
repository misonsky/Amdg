...
string_settings.add_argument('--corpus',type=str,default="ecomm",help='dialog/trans/summ')
...
string_settings.add_argument("--specific_test",type=str,default=None,help="specify the test set")
string_settings.add_argument("--specific_ref",type=str,default=None,help="specify the reference file")
...
string_settings.add_argument('--model_name_or_path',type=str,default="maskpretrain",help='Path to pretrained model or model identifier from huggingface.co/models')
...
boolean_settings.add_argument('--do_prepare',action="store_true",default=False,help='prepare the dataset for supervised training')
boolean_settings.add_argument('--do_train',action="store_true",default=False,help='train the supervised model')
boolean_settings.add_argument('--random_attention',action="store_true",default=False,help="random the attention weight")
boolean_settings.add_argument('--do_eval',action="store_true",default=False,help='Whether to run eval on the dev set.')
boolean_settings.add_argument('--do_predict',action="store_true",default=False,help='prediction the result for supervised')
...
boolean_settings.add_argument('--filter_parameters',type=bool,default=True,help='whether drop the last dataset')
...
scaler_settings.add_argument('--max_decode_length',type=int,default=128,help='length for decoder')
scaler_settings.add_argument('--min_decode_length',type=int,default=5,help='length for decoder')
...
scaler_settings.add_argument('--per_gpu_train_batch_size',type=int,default=32,help='Batch size per GPU/TPU core/CPU for training.')
scaler_settings.add_argument('--per_gpu_eval_batch_size',type=int,default=32,help='Batch size per GPU/TPU core/CPU for evaluation.')
...
scaler_settings.add_argument('--num_train_epochs',type=int,default=200,help='Total number of training epochs to perform.')
...
scaler_settings.add_argument('--learning_rate',type=float,default=5e-6,help='The initial learning rate for Adam.')
scaler_settings.add_argument('--weight_decay',type=float,default=0.0004,help='Weight decay if we apply some.')
...
scaler_settings.add_argument('--seed',type=int,default=12345,help="12345/67891/189657/245675")
